...
const pages = [
  {
    title: "Home",
    icon: <HomeIcon />,
    arr: ["Dashboard", "Advanced Dashboard", "Analytics Dashboard"],
  },
  ...
  },
  {
    title: "Maintenance",
    icon: <SettingsIcon />,
    arr: ["Search", "Add maintenance", "Type of operation", "Custom Profile"],
  },
];
...
export const Navbar = (props) => {
  ...
  return (
    <>
      ...
      <AppBar
        position="fixed"
        sx={{ zIndex: 1301, backgroundColor: "#f4d24a", height: "69px" }}
      >
              ...
              <Tooltip title="Open settings">
                ...
                >
                  <div
                    style={{
                      background:
                        "linear-gradient(to right, rgb(253, 215, 52), #828b94)",
                    }}
                  >
