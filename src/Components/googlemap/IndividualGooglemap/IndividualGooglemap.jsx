...
// //   <div className="popupElement">
// //     {/* <div style={{backgroundColor:"#f4d24a"}>mycontent</div> */}
// //     <div>{icon}</div>
// //     <span style={{ fontSize: "0.9rem", color: "black" }}>{text}</span>
// //   </div>
// // );
...
// async function fetchData() {
//   const apiUrl = `
// https://rocketsalestracker.com/api/reports/stops?deviceId=2431&from=2024-08-17T18%3A30%3A00.000Z&to=2024-08-24T18%3A29%3A59.999Z`;
...
//   try {
//       // Make a request to the API with authorization header
//       const response = await fetch(apiUrl, {
//           headers: {
//               'Authorization': `Basic ${token}`
//           }
...
//                             <div className="name">
//                                 <PopupElement
//                                     text={new Date(stop.startTime).toLocaleString()} // Use stop.startTime here
//                                 />
//                             </div>
//                         </div>
//                     </div>
...
//                         <PopupElement
//                             icon={<FaDownload style={{ color: "black" }} />}
//                             text={`Arrival Time: ${new Date(stop.startTime).toLocaleString()}`} // Use stop.startTime here
//                         />
//                         <PopupElement
//                             icon={<FaUpload style={{ color: "black" }} />}
//                             text={`Departure Time: ${new Date(stop.endTime).toLocaleString()}`} // Use stop.endTime here
//                         />
//                         <PopupElement
//                             icon={<GiDuration style={{ color: "black" }} />}
//                             text={`Duration Time: ${Math.floor(stop.duration / 1000)} seconds`} // Convert duration to seconds
//                         />
//                         <PopupElement
//                             icon={<FaRoad style={{ color: "black" }} />}
//                             text={`Last Km: ${stop.distanceFromPrevious}`} // Use stop.distanceFromPrevious here
//                         />
//                         <PopupElement
//                             icon={<MdLocationPin style={{ color: "black" }} />}
//                             text={address}
//                             // text={`Lat: ${stop.latitude}, Lon: ${stop.longitude}`} // Use stop latitude and longitude here
//                         />
//                     </div>
//                 </div>
//             </Popup>
